 ...
 * Fixer instead.
 */
export declare function buildReplacementFixer(potentialReplacementGenerator: (node: ts.Node, v?: boolean) => ({
    replaceWith: string;
} | undefined)): Fixer;
/**
 ...
 * that).
 */
export declare function maybeAddNamedImport(source: ts.SourceFile, importWhat: string, fromFile: string, importAs?: string, tazeComment?: string, v?: boolean): IndividualChange | undefined;
/**
 ...
 * that).
 */
export declare function maybeAddNamespaceImport(source: ts.SourceFile, fromFile: string, importAs: string, tazeComment?: string, v?: boolean): IndividualChange | undefined;
