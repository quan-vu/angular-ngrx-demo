 ...
 */
export declare class ConformancePatternRule<P extends PatternKind> implements AbstractRule {
    readonly ruleName: string;
    readonly code = ErrorCode.CONFORMANCE_PATTERN;
    private readonly engine;
    constructor(config: Config<P>, fixer?: Fixer<MatchedNodeTypes[P]>, verbose?: boolean);
